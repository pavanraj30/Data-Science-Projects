...
st.markdown("""
# NFL Football Stats (Rushing) Web App
This web app performs simple webscraping of NFL Football player stats data (Rushing).
...
""" if st.button('Intercorrelation Heatmap'):
    ...
    df_numeric = df_s elected_team.select_dtypes(include=[np.number])
